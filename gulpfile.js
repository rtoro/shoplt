...
gulp.task('build', function () {
    ...
    gulp.src('./node_modules/datatables.net-responsive-bs4/js/responsive.bootstrap4.min.js').pipe(gulp.dest('./src/main/resources/static/js'));
    gulp.src('./node_modules/datatables.net-responsive-bs4/css/responsive.bootstrap4.min.css').pipe(gulp.dest('./src/main/resources/static/css'));
});
